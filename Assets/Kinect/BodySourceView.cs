...
public class BodySourceView : MonoBehaviour 
{
    ...
    void Update () 
    {
        ...
        foreach(var body in data)
        {
            ...
            if(body.IsTracked)
            {
                ...
                {
                    GestureManager.GetComponent<GestureDector>().CheckForGestures(body);
                }
    ...
    private GameObject CreateBodyObject(ulong id)
    {
        ...
        body.AddComponent<HandsUp>();
        body.GetComponent<HandsUp>().headMaterials = headMaterials;
        ...
        for (Kinect.JointType jt = Kinect.JointType.SpineBase; jt <= Kinect.JointType.ThumbRight; jt++)
        {
            ...
            if (jtName == "Head")
            {
                ...
                jointObj.AddComponent<RotateAround>();
                jointObj.AddComponent<PlayGIF>();
            ...
            } else if (jtName == "HandRight")
            {
                ...
                jointObj.AddComponent<ExplodeHighFive>();
                jointObj.GetComponent<ExplodeHighFive>().explosion = explosionPrefab;
            } else if (jtName == "FootRight" || jtName == "FootLeft") {
    ...
    private void DetectHandsAboveHead()
    {
